# Dilemma Max `cufarvid` keymap

The Dilemma Max `cufarvid` keymap is based on the original [Dilemma Max](../via/readme.md). Keymap is heavily inspired by [Miryoku](https://github.com/manna-harbour/miryoku).
